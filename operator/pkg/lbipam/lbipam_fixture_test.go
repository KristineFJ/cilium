...
func mkTestFixture(pools []*cilium_api_v2alpha1.CiliumLoadBalancerIPPool, ipv4, ipv6 bool, initDone func()) *LBIPAMTestFixture {
	...
	fixture.hive = hive.New(
		...
		cell.Provide(func(lc hive.Lifecycle, c k8sClient.Clientset) resource.Resource[*core_v1.Service] {
			return resource.New[*core_v1.Service](
				lc, utils.ListerWatcherFromTyped[*core_v1.ServiceList](
					c.CoreV1().Services(""),
				),
			)
		}),
		...
		cell.Provide(func() *operatorOption.OperatorConfig {
			return &operatorOption.OperatorConfig{
				BGPAnnounceLBIP: true,
			}
		}),
	...
	// Set the LB-IPAM enable flag.
	flags := pflag.NewFlagSet("", pflag.ContinueOnError)
	fixture.hive.RegisterFlags(flags)
